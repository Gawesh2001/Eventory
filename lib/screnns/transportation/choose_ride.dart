    ...
    'Car': [
      {
        'name': 'Suzuki Wagon R',
        'image':
            'https://th.bing.com/th/id/OIP.8i4QnFe7JRYUGznMl3rAmAHaFa?rs=1&pid=ImgDetMain',
        'price': 'LKR 900'
      },
      {
        'name': 'Toyota Aqua',
    ...
    'Van': [
      {
        'name': 'Toyota Hiace',
        'image':
            'https://static.vecteezy.com/system/resources/previews/035/976/525/original/ai-generated-a-cartoon-van-free-png.png',
        'price': 'LKR 2500'
      },
      {
        'name': 'Nissan Caravan',
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage: NetworkImage(
                      'https://lk-aps.bmscdn.com/events/eventlisting/ET00005204.jpg'),
                ),
                title: Text('Kalaa Tharanaya',
                    style: TextStyle(fontWeight: FontWeight.bold)),
                subtitle:
                    Text('Keells - Colombo 4 to Kalaa Tharanaya, Colombo 10'),
              ),
            ),
          ),
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color:
                            selectedType == type ? Colors.white : Colors.orange,
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              CarBookingPage(vehicle: vehicle),
                        ),
                      );
                    },
                  ),
